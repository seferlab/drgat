...
def run(cfg: Dict[str, Any], out_dir: Path) -> Dict[str, Any]:
    ...
    for drug in drugs:
        ...
        table_rows.append({
            "drug": drug,
            "pdx_auc_drgat": res_pdx_aug.get("test_roc_auc"),
            "tcga_auc_drgat": res_tcga_aug.get("test_roc_auc"),
            "pdx_auc_drgat_noaug": res_pdx_noaug.get("test_roc_auc"),
            "tcga_auc_drgat_noaug": res_tcga_noaug.get("test_roc_auc"),
        })
